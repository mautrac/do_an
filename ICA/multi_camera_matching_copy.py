...
class MultiCameraMatching(object):
    ...
    def matching(self, cam_in_id, cam_out_id, interval_out=[0, 2001], interval_in=[0, 2001], \
        ...
        print('cam: {}; tracks: {} \t track_time: {}'.format(cam_out_id, len(out_time_out_arr), np.sort(out_time_out_arr)))
    ...
    def forward_matching(self, mode='linear', st_dim=0, en_dim=2048, is_test=False, cam_out_id=10, cam_in_id=11):
        ...
        # positve matching
        for cam_out_id, cam_in_id in pre_defined_path:
        ...
        # negative matching
        for cam_in_id, cam_out_id in pre_defined_path[::-1]:
            print('out: {}; in: {}'.format(cam_out_id, cam_in_id))
...
matcher.forward_matching(mode=args.mode, st_dim=args.st_dim, en_dim=args.en_dim, is_test=False, cam_out_id=13, cam_in_id=14)
